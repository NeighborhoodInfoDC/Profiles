    ...
    merge
      ...
      ACS.Acs_5yr_sum_tr&geosuf
        (keep=&geo TotPop: mTotPop: 
         ...
         rename=(TotPop_2005_09=TotPop_tr_2005_09 mTotPop_2005_09=mTotPop_tr_2005_09))
  ...
  ** End submitting commands to remote server **;
  ...
  data Nbr_profile&geosuf (compress=no);
    ...
    ** Population **;
    ...
    if TotPop_2000 > 0 then PctChgTotPop_2000_2005_09 = %pctchg( TotPop_2000, TotPop_2005_09 );
    ...
    label
      ...
      PctChgTotPop_2000_2005_09 = "% change population, 2000 to 2005-09"
      PctChgTotPop_2000_2010 = "% change population, 2000 to 2010"
      ;
      
    %Pct_calc( var=PctPopUnder18Years, label=% children, num=PopUnder18Years, den=TotPop, years=1980 1990 2000 2005_09 2010 )
    
    %Moe_prop_a( var=PctPopUnder18Years_m_2005_09, mult=100, num=PopUnder18Years_2005_09, den=TotPop_2005_09, 
                       num_moe=mPopUnder18Years_2005_09, den_moe=mTotPop_2005_09 );
    ...
    if PopUnder18Years_2000 > 0 then PctChgPopUnder18Yea_2000_2005_09 = %pctchg( PopUnder18Years_2000, PopUnder18Years_2005_09 );
    ...
    label
      ...
      PctChgPopUnder18Yea_2000_2005_09 = "% change child population, 2000 to 2005-09"
    ...
    %Pct_calc( var=PctForeignBorn, label=% foreign born, num=PopForeignBorn, den=TotPop_tr, years=2005_09 )

    %Moe_prop_a( var=PctForeignBorn_m_2005_09, mult=100, num=PopForeignBorn_2005_09, den=TotPop_tr_2005_09, 
                       num_moe=mPopForeignBorn_2005_09, den_moe=mTotPop_tr_2005_09 );
    ...
    ** Population by Race/Ethnicity **;
    ...
    %Pct_calc( var=PctBlackNonHispBridge, label=% black non-Hispanic, num=PopBlackNonHispBridge, den=PopWithRace, years=1990 2000 2005_09 2010 )
    %Pct_calc( var=PctWhiteNonHispBridge, label=% white non-Hispanic, num=PopWhiteNonHispBridge, den=PopWithRace, years=1990 2000 2005_09 2010 )
    %Pct_calc( var=PctHisp, label=% Hispanic, num=PopHisp, den=PopWithRace, years=1990 2000 2005_09 2010 )
    %Pct_calc( var=PctAsianPINonHispBridge, label=% Asian/P.I. non-Hispanic, num=PopAsianPINonHispBridge, den=PopWithRace, years=1990 2000 2005_09 2010 )
    ...
    %Pct_calc( var=PctOtherRaceNonHispBridg, label=% other race non-Hispanic, num=PopOtherRaceNonHispBridg, den=PopWithRace, years=2005_09 )

    ** Family Risk Factors **;

    %Pct_calc( var=PctPoorPersons, label=Poverty rate (%), num=PopPoorPersons, den=PersonsPovertyDefined, years=1980 1990 2000 2005_09 )
    %Pct_calc( var=PctUnemployed, label=Unemployment rate (%), num=PopUnemployed, den=PopInCivLaborForce, years=1980 1990 2000 2005_09 )
    %Pct_calc( var=Pct16andOverEmployed, label=% pop. 16+ yrs. employed, num=Pop16andOverEmployed, den=Pop16andOverYears, years=1980 1990 2000 2005_09 )
    %Pct_calc( var=Pct25andOverWoutHS, label=% persons without HS diploma, num=Pop25andOverWoutHS, den=Pop25andOverYears, years=1980 1990 2000 2005_09 )
    %Pct_calc( var=PctFamiliesOwnChildrenFH, label=% female-headed families with children, num=NumFamiliesOwnChildrenFH, den=NumFamiliesOwnChildren, years=1990 2000 2005_09 )
    
    %Moe_prop_a( var=PctPoorPersons_m_2005_09, mult=100, num=PopPoorPersons_2005_09, den=PersonsPovertyDefined_2005_09, 
                       num_moe=mPopPoorPersons_2005_09, den_moe=mPersonsPovertyDefined_2005_09 );
    
    %Moe_prop_a( var=PctUnemployed_m_2005_09, mult=100, num=PopUnemployed_2005_09, den=PopInCivLaborForce_2005_09, 
                       num_moe=mPopUnemployed_2005_09, den_moe=mPopInCivLaborForce_2005_09 );
    
    %Moe_prop_a( var=Pct16andOverEmployed_m_2005_09, mult=100, num=Pop16andOverEmployed_2005_09, den=Pop16andOverYears_2005_09, 
                       num_moe=mPop16andOverEmployed_2005_09, den_moe=mPop16andOverYears_2005_09 );
    
    %Moe_prop_a( var=Pct25andOverWoutHS_m_2005_09, mult=100, num=Pop25andOverWoutHS_2005_09, den=Pop25andOverYears_2005_09, 
                       num_moe=mPop25andOverWoutHS_2005_09, den_moe=mPop25andOverYears_2005_09 );
    
    %Moe_prop_a( var=PctFamiliesOwnChildFH_m_2005_09, mult=100, num=NumFamiliesOwnChildrenFH_2005_09, den=NumFamiliesOwnChildren_2005_09, 
                       num_moe=mNumFamiliesOwnChildFH_2005_09, den_moe=mNumFamiliesOwnChildren_2005_09 );
    
    ** Isolation Indicators **;
    
    %Pct_calc( var=PctHshldPhone, label=% HHs with a phone, num=NumHshldPhone, den=NumOccupiedHsgUnits, years=2000 2005_09 )
    %Pct_calc( var=PctHshldCar, label=% HHs with a car, num=NumHshldCar, den=NumOccupiedHsgUnits, years=2000 2005_09 )
    
    %Moe_prop_a( var=PctHshldPhone_m_2005_09, mult=100, num=NumHshldPhone_2005_09, den=NumOccupiedHsgUnits_2005_09, 
                       num_moe=mNumHshldPhone_2005_09, den_moe=mNumOccupiedHsgUnits_2005_09 );
    
    %Moe_prop_a( var=PctHshldCar_m_2005_09, mult=100, num=NumHshldCar_2005_09, den=NumOccupiedHsgUnits_2005_09, 
                       num_moe=mNumHshldCar_2005_09, den_moe=mNumOccupiedHsgUnits_2005_09 );
    
   ** Child Well-Being Indicators **;
    
    %Pct_calc( var=PctPoorChildren, label=% children in poverty, num=PopPoorChildren, den=ChildrenPovertyDefined, years=1990 2000 2005_09 )
    
    %Moe_prop_a( var=PctPoorChildren_m_2005_09, mult=100, num=PopPoorChildren_2005_09, den=ChildrenPovertyDefined_2005_09, 
                       num_moe=mPopPoorChildren_2005_09, den_moe=mChildrenPovertyDefined_2005_09 );
    ...
    ** Income Conditions **;
    ...
    %Pct_calc( var=AvgFamilyIncome, label=Average family income last year ($), num=AggFamilyIncome, den=NumFamilies, mult=1, years=1980 1990 2000 2005_09 )
    ...
    %dollar_convert( AvgFamilyIncome_2005_09, AvgFamilyIncAdj_2005_09, 2009, &inc_dollar_yr )
    ...
    label
      ...
      AvgFamilyIncAdj_2005_09 = "Avg. family income, 2005-09"
      ;
      
    AvgFamilyIncome_m_2005_09 = 
      %Moe_ratio( num=AggFamilyIncome_2005_09, den=NumFamilies_2005_09, 
                  num_moe=mAggFamilyIncome_2005_09, den_moe=mNumFamilies_2005_09 );
                        
    %dollar_convert( AvgFamilyIncome_m_2005_09, AvgFamilyIncAdj_m_2005_09, 2009, &inc_dollar_yr )
    ...
    if AvgFamilyIncAdj_2000 > 0 then PctChgAvgFamilyIncA_2000_2005_09 = %pctchg( AvgFamilyIncAdj_2000, AvgFamilyIncAdj_2005_09 );
    ...
    label
      ...
      PctChgAvgFamilyIncA_2000_2005_09 = "% change in avg. family income, 2000 to 2005-09"
      ;
    
    PctChgAvgFamIncA_m_2000_2005_09 = AvgFamilyIncAdj_m_2005_09 / AvgFamilyIncAdj_2000;
    ...
    ** Housing Conditions **;
    ...
    %Label_var_years( var=NumOccupiedHsgUnits, label=Occupied housing units, years=1980 1990 2000 2005_09 2010 )

    %Pct_calc( var=PctVacantHsgUnitsForRent, label=Rental vacancy rate (%), num=NumVacantHsgUnitsForRent, den=NumRenterHsgUnits, years=1980 1990 2000 2005_09 )
    %Pct_calc( var=PctOwnerOccupiedHsgUnits, label=Homeownership rate (%), num=NumOwnerOccupiedHsgUnits, den=NumOccupiedHsgUnits, years=1980 1990 2000 2005_09 )
    
    %Moe_prop_a( var=PctVacantHUForRent_m_2005_09, mult=100, num=NumVacantHsgUnitsForRent_2005_09, den=NumRenterHsgUnits_2005_09, 
                       num_moe=mNumVacantHUForRent_2005_09, den_moe=mNumRenterHsgUnits_2005_09 );
    
    %Moe_prop_a( var=PctOwnerOccupiedHU_m_2005_09, mult=100, num=NumOwnerOccupiedHsgUnits_2005_09, den=NumOccupiedHsgUnits_2005_09, 
                       num_moe=mNumOwnerOccupiedHU_2005_09, den_moe=mNumOccupiedHsgUnits_2005_09 );
